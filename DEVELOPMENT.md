...
```bash
git remote add encore encore://saas-validator-suite-aeci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/saas-validator-suite-aeci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/saas-validator-suite-aeci/settings/integrations/github)
